...
function InternshipInstructionHeader() {
...
const handleTicket = () => {
  ...
  return (
    <div>
                    ...
                    <header className=" head fixed-top d-flex justify-content-between align-items-center py-6 px-8 p-1 border-bottom border-dark-subtle">
                      <div className="d-flex justify-content-center align-items-center">
                        ...
                        <nav>
                          ...
                          <span
                            className="px-1 text-white"
                          >
                            {decryptedprojectpage.replace("File", "")} 
                          </span>
                        </nav>
                      </div>
...
export default InternshipInstructionHeader;
