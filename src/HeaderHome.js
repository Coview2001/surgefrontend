...
// import { faSignOut, faBell, faEnvelope, faBug, faHome, faTicket } from '@fortawesome/free-solid-svg-icons';
...
//             <FontAwesomeIcon icon={faBug} onClick={handleReportBug} className="icons text-white" />
//           </span>
...
//             </div>
//             <Dropdown.Divider />
//             <Dropdown.Item className='rounded-pill outline-white  mb-2 text-white Logout' title='Logout' onClick={handleLogOut}><FontAwesomeIcon icon={faSignOut} className="me-1"/>Logout</Dropdown.Item>
//           </Dropdown.Menu>
//         </Dropdown>
//       </nav> 
//     </header>
...
// import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';
// import { faSignOut, faBug, faHome, faTicket } from '@fortawesome/free-solid-svg-icons';
// import html2canvas from 'html2canvas';
// import axios from 'axios';
// import logo from './Img/logo.png';
// import './SQL and PY/Header.css';
...
//       } catch (error) {
//           console.error('Error capturing screenshot:', error);
//           alert('Failed to capture screenshot. Proceeding to bug report page.');
//           navigate('/BugReportPage');
//       } finally {
...
//                 <nav className="ms-auto">
//                     <Dropdown className="d-flex justify-content-center">
//                         <span className="px-2 custom-btnEditor" title="Report Bug">
//                             <FontAwesomeIcon 
//                                 icon={faBug} 
//                                 onClick={handleReportBug} 
//                                 className={`icons text-white ${isCapturingScreenshot ? 'disabled' : ''}`} 
//                             />
//                             {isCapturingScreenshot && <Spinner animation="border" size="sm" className="ms-1" />}
//                         </span>
//                         <span className="px-2 custom-btnEditor" onClick={handleTicket} title="Ticket">
//                             <FontAwesomeIcon icon={faTicket} className="icons text-white" />
//                         </span>
...
//                             <FontAwesomeIcon icon={faHome} className="icons text-white" />
//                         </span>
//                         <Dropdown.Toggle variant="rounded-sm rounded-circle px-1" id="dropdown-basic" title={userName} style={{color:'#7335B7'}}>
